...
function statusLabel(value: string) {
  const labels: Record<string, string> = { draft: "Ciorna", planned: "Planificata", active: "Activa", completed: "Finalizata", cancelled: "Anulata", prospect: "Prospect", inactive: "Inactiv", overdue: "Restanta", in_term: "In termen", due_soon: "Scadenta curand", BOOKED: "Inchiriata", HOLD: "Hold", RESERVED: "Rezervata" };
