...
assert.equal(hasPermission("COO", "finance.integrations.saga.view"), true);
assert.equal(hasPermission("COO", "finance.integrations.saga.reconcile"), true);
assert.equal(hasPermission("COO", "finance.integrations.saga.sync"), false);
assert.equal(hasPermission("FINANCE_OPERATOR", "finance.integrations.saga.view"), true);
assert.equal(hasPermission("FINANCE_OPERATOR", "finance.integrations.saga.sync"), true);
assert.equal(hasPermission("FINANCE_OPERATOR", "finance.integrations.saga.reconcile"), true);
assert.equal(hasPermission("FINANCE_OPERATOR", "finance.integrations.saga.configure"), false);
assert.equal(hasPermission("SALES_DIRECTOR", "finance.integrations.saga.view"), false);
assert.equal(hasPermission("SALES_AGENT", "finance.integrations.saga.view"), false);
assert.equal(hasPermission("FIELD_OPERATOR", "finance.integrations.saga.view"), false);
