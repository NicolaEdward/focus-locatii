...
import { listReceivableAliases } from "@/lib/receivables-workspace-service";

export const dynamic = "force-dynamic";

export async function GET(request: NextRequest) {
  return observeRoute(request, { route: "/api/admin/receivables-workspace/aliases", operation: "receivables.aliases" }, async () => {
    ...
    const data = await listReceivableAliases({
