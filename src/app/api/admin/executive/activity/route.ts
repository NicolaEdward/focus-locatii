...
import { getExecutiveActivity } from "@/lib/dashboard/executive/refinement";
...
export async function GET(request: NextRequest) {
  return observeRoute(request, {
    route: "/api/admin/executive/activity",
    operation: "executive.activity"
  }, async () => {
    ...
    return NextResponse.json(await getExecutiveActivity(session, query), {
